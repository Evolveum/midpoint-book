...
Identifier management is one the most crucial mechanisms in IDM deployment.

* Make sure that identifier management is done in a single system in a consistent way.
