...
Never maintain application roles manually.
...
Beware of AI.
It is especially dangerous for re-certificatin campaigns, as they are usually the last defense against privilege accumulation.
