...
// TODO !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! TODO
// TODO: This chapter needs to be updated to midPoint 4.4
// TODO !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! TODO
...
Adding the `Type` suffix to data types is a common convention in midPoint.
...
But then there are features that are quite complex or features that involve some degree of exploration to implement.
...
This indicates *temporary* inactivation and there is an intent enable the entity later.
...
Therefore XSD does not really hold us back that much.
...
And it does not make any sense for us to switch one buzzword for another only to remain cool.
