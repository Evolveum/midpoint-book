...
Obviously, there is a way how to set up privileges that apply to managers:
...
TODO: concept of _relation_
TODO: role owners

TODO: bulti-in relations
TODO: relations are configurable

== Multiple Organizational Structures

Tree is a simple and very elegant structure in many ways.
But it takes a lot of trees to make a forrest.
