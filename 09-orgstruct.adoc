...
TODO: kind+intent are as identifiers for midPoint.

=== Names and Identifiers

TODO: create orginit name (has to be globally-unique)

TODO: add mapping to the example
...
TODO: benefit of persistent identifiers for orgs


=== Nesting Organizational Units

TODO: something is missing: nest the orgs inside each other

TODO: automatic assignment of org in inbound mapping
TODO: mention create on demand (for later)
