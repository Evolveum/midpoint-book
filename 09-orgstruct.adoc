...
.Focus and projection
TIP: _Focus_ and _projection_ may look like strange words to use for identity management concepts.
...
In this case we would use explicit _kind_ and _intent_ in the constuction:
