...
We will discuss that later, in <<09-object-templates#09-object-templates,Object Templates>> chapter.
...
We probably want to _generate_ usernames in a systematic and consistent way from now on, which will be described in <<09-object-templates#09-object-templates,Object Templates>> chapter.
