...
Import is usually not entirely trivial either, for example in cases when we try to import data from an additional data source into a running midPoint deployment.
...
Of course, midPoint has an easy solution for this: _correlation_ mechanism.
