...
We would also like to see business roles, application roles, system roles . And the enterprises would be lost without their divisions, departments and sections.
...
But often there are is a need to integrate midPoint with other systems that is beyond the capabilities of a connector.
...
This chapter may also be interesting to people who would like to extended midPoint in a unusual way or those that want to contribute to midPoint development.
...
* *Deployment examples:* This book is using a lot of examples in all the chapters.
...
After all, they way that copying and pasting is one the best ways how to learn.

* *Glossary:* Identity management and governance parlance may sound like a alien language to a newcomer.
...
Obviously, the best people to write those chapters are the people from the Evolveum team: the people that designed and implemented midPoint, the people that support midPoint deployments, people that work with midPoint every day, people that eat, breathe and sleep midPoint.
But those people are just engineers.
They need to pay their bills.
They cannot put away they day-to-day responsibilities to work on this book.
...
You can use Evolveum crowdfunding portal at https://wanted.evolveum.com/[wanted.evolveum.com].
Or in case you are considering a larger-scale sponsoring please contact Evolveum team directly.
