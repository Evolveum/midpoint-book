...
If you look for more formal system requirements definition then you will find that in midPoint wiki (see <<92-additional-information.adoc#92-additional-information,Additional Information>> chapter at the end of the book).
...
It allows importing new object in XML/JSON/YAML form.
...
In addition to the basic properties there are also other sections.
E.g. activation section shows whether the object is enabled or disabled, it shows the activation dates and other activation details.
The credentials section allows changing password and other credentials.
