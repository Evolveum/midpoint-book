...
// TODO: update - script installation

// TODO: explain use of sudo/root: secure by default
...
// TODO: also update troubleshooting chapter (logging)
...
// TODO: components of docker compose installation: midPoint, DB
...
However, our goal is to learn midPoint, messing around with docker may be a distraction.
...
There are no Windows or macOS versions only.
...
When local midPoitn instance is started, use the following URL to access midPoint user interface:
...
// TODO: update, if script prompts for password
...
When using the provided docker configuration, midPoint service is available on _localhost_ only, it is not accessible from the network.
This setup is reasonably safe for use on personal computers.
...
Choose PostgreSQL directory (a.k.a. _native repository_) to get reliable support for all midPoint features.
...
// TODO: update according to the script
