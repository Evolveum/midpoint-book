...
URL{nbsp}(version{nbsp}{midpointversion}):{nbsp}https://github.com/Evolveum/midpoint-samples/support-{midpointversion}/master/samples/book/ +
URL{nbsp}(latest{nbsp}development{nbsp}version):{nbsp}https://github.com/Evolveum/midpoint-samples/tree/master/samples/book/
