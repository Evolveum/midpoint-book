...
TIP: For the curious, LDAP resource configuration is located in `resource-ldap.xml` in samples directory.
...
You can think of midPoint as a _policy administration point_ (PAP).
