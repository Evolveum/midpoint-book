...
//:revdate: 2022-04-21
:revdate: {localdate}
:revnumber: 4.8.5-SNAPSHOT
:midpointversion: 4.8.5
:doctype: book
...
include::08-archetypes.adoc[]

include::09-focus-processing.adoc[]

include::10-orgstruct.adoc[]

// include::11-authorizations.adoc[]
