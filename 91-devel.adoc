...
Or those may be experimental features mean to explore a particularly interesting functionality.
...
Mailing list is used to discuss midPoint futures, announce new release, discuss configuration issues, provide feedback to the development team and so on.
