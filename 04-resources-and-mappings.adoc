...
However, username is still used as secondary identifier, and it still has to be unique.
...
Some systems have hierarchically-structured identifiers, others have flat unstructured identifiers.
...
When the account is deleted, midPoint deletes the shadow.
...
In addition to the account identifiers, shadow points to the corresponding resource definition, to make the identification complete.
...
There may be situations when this knowledge may be useful.
