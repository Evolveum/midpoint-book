...
// TODO: consider renaming this chapter, as it has more than just object templates
// TODO: Focus? Focus policy? Internal processing? Computing objects? Inside MidPoint's Head?
...
Otherwise poor Arnold Anderson won’t have his accounts created because `aanderso` username is already taken by Alice.
...
Once the basic configuration works, you can test username generator by adding Arnold Anderson to the HR CSV file and importing the account.
...
Once Arnold’s account is imported, a non-conflicting username should be generated for him:
...
image::08-04-users-final.png[Users]
